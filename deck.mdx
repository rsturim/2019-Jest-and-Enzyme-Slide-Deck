...
"Matchers" let you test value types in different ways.
...
shallow, what is means
console logging and the debug method of the wrapper

```
console.log(wrapper.debug());
```

searching for given nodes

-   find with length
-   find to exist to be true
-   ul children length
-   find ul, verify it has a specific class
-   find item, text == something specific

---

enzyme selectors

## there are 5 categories of accepted enzyme selectors

---

enzyme selectors (cont)
CSS selectors

-   html element -- h1
-   class syntax - '.btn-primary'
-   id syntax - '#section-one'
-   attribute syntax - [href='www.dealer.com/leads']
-   combined attribute syntax - a[href='www.dealer.com/leads']

---

enzyme selectors (cont)

prop selectorS - attribute syntax to look for the element
...
third categories entails referencing a component's constructor
...
fourth entails referencing a components display name
...
fifth -- object property selector
...
### Jest Snapshot testing with React Components
